<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPanel.Master" CodeBehind="KabKota.aspx.cs" Inherits="CMS.Master.KabKota" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:EntityServerModeDataSource runat="server" ID="KabKotaData" ContextTypeName="CMS.Context.CMSContext" 
    TableName="M_KABKOTA" OnSelecting="KabKotaData_Selecting" DefaultSorting="NAME ASC" />
        ...
        <Columns>
            <dx:GridViewBandColumn Caption="Data" VisibleIndex="0">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="PROVINSI_ID" Caption="PROVINSI ID" Settings-AllowHeaderFilter="True" />
                    <dx:GridViewDataTextColumn FieldName="CODE" Caption="CODE" />
