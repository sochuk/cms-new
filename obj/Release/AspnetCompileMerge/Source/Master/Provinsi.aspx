<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPanel.Master" CodeBehind="Provinsi.aspx.cs" Inherits="CMS.Master.Provinsi" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:EntityServerModeDataSource runat="server" ID="ProvinsiData" ContextTypeName="CMS.Context.CMSContext" 
    TableName="M_PROVINSI" OnSelecting="ProvinsiData_Selecting" DefaultSorting="NAME ASC" />
        ...
        <Columns>
            <dx:GridViewBandColumn Caption="Data" VisibleIndex="0">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="CODE" Caption="PROVINSI CODE" Settings-AllowHeaderFilter="True" />
